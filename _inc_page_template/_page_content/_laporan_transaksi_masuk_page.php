        ...
        <div class="card-body">
            ...
            <div class="d-md-flex align-items-center">
                <div>
                    ...
                    <h5 class="card-subtitle">Daftar Transaksi Masuk</h5>
                </div>
                <div class="ml-auto">                  
                  <div class="dl">
                      <a href="#" class="btn btn-block create-btn text-white no-block d-flex align-items-center"style="background: #CF000F;" onclick="goToReportMasuk()"><i class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">Cetak Data Ini</span> </a>
                  </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                          <form method="POST" action="/" novalidate class="find_report_transaksi_masuk" id="find_report_transaksi_masuk">
                            <div class="row">
                              <div class="col-3">
            ...
            <div class="table-responsive" style="padding:10px;font-size: 12px;">
                <table class="table table-bordered" cellspacing="0" id="tb_transaksi_masuk">
                    <thead>
                        <tr class="bg-light">
